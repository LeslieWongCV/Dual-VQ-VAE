...
from models.betavae_3_add import BetaVAE_H
...
class VQVAE(nn.Module):
    ...
    def forward(self, x, verbose=False):
        ...
        z_beta_r = z_beta.repeat(1, 64).view(z_q.shape)
        total_z_q = z_q + z_beta_r

        MI = 10*self.getMutualInformation(z_q, z_beta_r)
        x_hat = 10*self.decoder(total_z_q)
